...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://101883839381557"
...
ImageButton1.Image = "rbxassetid://101883839381557"
...
local Library = Update:Window("Viper Cat Hub [Zeisha]","",Enum.KeyCode.RightControl);
...
NguyenTien:AddLabel("Viper Huh [Zeisha]")

NguyenTien:AddLabel("Support My Discord : Viper Hub")

NguyenTien:AddLabel("Ui: Viper Hubz")
...
NguyenTien:AddButton("Tiktok Official",function()

setclipboard("tiktok.com/@viperakosiv")
...
setclipboard("https://www.facebook.com/share/1PtkCb8vHX/")
...
spawn(function()
            ...
            pcall(function()
                ...
                elseif QuestGui.Visible then
                    ...
                    if string.find(questText, "kissed") then
                                ...
                                if string.find(v.Name, "kissed Warrior") then
                                    if string.find(questText, NameMon) then
                                        repeat task.wait()
                                            ...
                                            TP1(PosMon * CFrame.new(PosX, PosY, PosZ))
                        ...
                        -- Fallback if no valid "kissed Warrior" is found
                        TP1(CFrameMon)
                        StartMagnet = false
   ...
   -- Toggle for Nearest Enemy Auto Farm
...
-- Label for Chest Farming
Main:AddLabel("Chest Farm")

-- Toggle for Chest Auto Farm
        ...
        if AutoFarmChest then
            for _, v in pairs(game:GetService("Workspace"):GetChildren()) do 
                if v.Name:find("Chest") and v:IsA("BasePart") then
                    ...
                    if (v.Position - playerPos).Magnitude <= 5000 + _G.MagnitudeAdd then
                        repeat task.wait()
                        ...
                        -- Return to player position after collecting
                        HyperCahaya(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
