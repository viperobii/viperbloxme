...
local ReplicatedStorage = game:GetService("ReplicatedStorage") local VirtualUser = game:GetService("VirtualUser") local RunService = game:GetService("RunService") local Players = game:GetService("Players") local Player = Players.LocalPlayer -- Ensure Player is properly defined

local Remotes = ReplicatedStorage:WaitForChild("Remotes", 5) if not Remotes then warn("Remotes not found!") return end

local CommF = Remotes:FindFirstChild("CommF_") if not CommF then warn("CommF_ remote not found!") return end

local Enemies = workspace:WaitForChild("Enemies", 5) local Boats = workspace:WaitForChild("Boats", 5)

if not Enemies or not Boats then warn("Enemies or Boats not found in workspace!") return end
