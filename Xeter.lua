    ...
    if seaBeasts then
        for _, v1832 in pairs(seaBeasts:GetChildren()) do
            if v1832 and 
               ...
               ((v1832:FindFirstChild("Humanoid") and v1832.Humanoid.Health > 0) or not v1832:FindFirstChild("Humanoid")) then
                return v1832; -- FIXED: return the beast instead of true
            end
        end
    end
