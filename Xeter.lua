...
Closed.Image = "rbxassetid://15388425623"
...
---------------------------------------------------------------------------Create Tab
local SOMEXHUB = library:AddWindow("Min XT V1",Enum.KeyCode.RightControl)
local Main = SOMEXHUB:AddTab("Level Farm","13075651575")
local M = SOMEXHUB:AddTab("Auto Item Quest","13075622619")
local Ss = SOMEXHUB:AddTab("Stats","7040410130")
local RaceV4 = SOMEXHUB:AddTab("RaceV4","11162889532")
local P = SOMEXHUB:AddTab("Player","7251993295")
local R = SOMEXHUB:AddTab("Raid","11155986081")
local T = SOMEXHUB:AddTab("Teleport","11155851001")
local S = SOMEXHUB:AddTab("Shop","6031265976")
local D = SOMEXHUB:AddTab("Devil Fruit","7044233235")
...
spawn(function()
   ...
   if World3 then   
	   ...
	   Main:AddToggle("Auto Chest",_G.chestsea3,function(value)
	_G.chestsea3 = value
	StopTween(_G.chestsea3)
	  ...
	  if World2 then
	   ...
	   Main:AddToggle("Auto Chest",_G.chestsea2,function(value)
	_G.chestsea2 = value
	StopTween(_G.chestsea2)
   end)
	   end
   
Main:AddToggle("Auto Chest Mirage island",false,function(value)
...
Main:AddToggle("Bypass Tp",false,function(Fast)
BypassTP = Fast
end)
    ...
    while wait() do
		pcall(function()
			if UseskillKill then
				game:GetService("VirtualInputManager"):SendKeyEvent(true,"Z",false,game) wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(false,"Z",false,game) wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(true,"X",false,game) wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(false,"X",false,game) wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(true,"C",false,game) wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(false,"C",false,game) wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(true,"V",false,game) wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(false,"V",false,game)
			end
		end)
    end
